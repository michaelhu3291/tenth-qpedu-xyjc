...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		$("<div style='background: #3B5617;color: #FFFFFF;' class='loading ui-state-default ui-state-active' id='load_"+this.id+"'>"+this.p.loadtext+"</div>").insertBefore(gv);
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pgbuttons===true) {
				...
				pgl += "<td title='第一页' id='"+po[0]+"' class='ui-pg-button ui-corner-all'><i class='fa fa-step-backward'></i></td>";
				pgl += "<td title='上一页' id='"+po[1]+"' class='ui-pg-button ui-corner-all'><i class='fa fa-backward'></i></td>";
				pgl += pginp !== "" ? sep+pginp+sep:"";
				pgl += "<td title='下一页' id='"+po[2]+"' class='ui-pg-button ui-corner-all'><i class='fa fa-forward'></i></td>";
				pgl += "<td title='最后一页' id='"+po[3]+"' class='ui-pg-button ui-corner-all'><i class='fa fa-step-forward'></i></td>";
