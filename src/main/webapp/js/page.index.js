$(document).ready(function() {
	...
	var $doc = $("body"), $header = $(".nx-header"), $left = $(".leftPane"), $content = $(".nx-content"), $breadcrumb = $content.find(".nx-breadcrumb"), $iframe = $content.find("#contentFrame");
...
/*	$header.find(".ui-pagedmenu-panel").pagedmenu({
	...
	var fullScreen = function() {
		var $he = $(".nx-header"), $le = $(".leftPane"), $con = $(".nx-content"), oh = $he.outerHeight(true)+10, ol = $le.outerWidth(true)+10;
	...
	var cancleFullScreen = function() {
		var $he = $(".nx-header"), $le = $(".leftPane"), $con = $(".nx-content");
		/*
...
//			 window.frames["contentFrame"].location.replace("pages/statistical.jsp");
...
//定义弹出窗体（可以覆盖到最大）
	...
	var switchUser = function(roleId) {
		...
		$.getJSON(url).done(function(data) {
			...
			var n = data.displayName, ous = data.otherUsers, $nx = $("#nxbbbb"), $otherUsers = $nx.find("ul");
			$nx = $("#nxbbbb").find("label").text(n);
		    ...
		    for (var i = 0; i < js("leftMenu").length; i++)
		    {
		        js("leftMenu")[i].onclick = function () {
		            delBackgroundColor();
		    ...
		    function delBackgroundColor()
		    {
		        for (var i = 0; i < js("leftMenu").length; i++)
		        {
		            js("leftMenu")[i].style.background = '';
		            js("leftMenu")[i].style.color = '#384463';
		        }
		    }
			$("body").unMask();
			//
