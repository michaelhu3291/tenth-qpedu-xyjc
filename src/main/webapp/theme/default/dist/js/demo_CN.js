...
(function ($, AdminLTE) {
  ...
  demo_settings.append(
      ...
      //+ "<div class='form-group'>"
      //+ "<label class='control-sidebar-subheading'>"
      //+ "<input type='checkbox' data-togglehomepage='classic' class='pull-right'/> "
      //+ "切换经典首页风格"
      //+ "</label>"
      ////+ "<p>Toggle between dark and light skins for the right sidebar</p>"
      //+ "</div>"
...
//切换经典首页风格
//  $("[data-togglehomepage]").on('click', function () {
//      window.location.replace("/pages/homePage_classic.jsp");
//  });
