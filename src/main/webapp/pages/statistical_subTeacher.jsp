     ...
     $.ajax({
        ...
        if(length > 0){
          for (var i = 0; i < length; i++) {
             ...
             $("#gonggao").append("<label style='margin-left:10px;'>暂无数据</label>");
        }
      }
    }); 
      ...
      $.ajax({
        ...
        if(length > 0){
          for (var i = 0; i < length; i++) {
             ...
             $("#tongzhi").append("<label style='margin-left:10px;'>暂无数据</label>");
         }
                    ...
                    <div class="col-md-7 connectedSortable ui-sortable" style="width: 50%;">
                        <div class="box box-solid bg-white-gradient">
                            <div class="box-header">
                                ...
                                <h3 class="box-title" style="color:black;font-size: 16px;margin-left:10px;">通&nbsp;知</h3>
                    ...
                    <div class="col-md-5 connectedSortable" style="width: 50%;">
                        <div class="box box-solid bg-white-gradient">
                            <div class="box-header">
                                ...
                                <h3 class="box-title" style="color:black;font-size: 16px;margin-left:10px;">公&nbsp;告</h3>
                                <!-- tools box -->
                                <div class="pull-right box-tools">
                        ...
                        <div class="box box-solid bg-white-gradient">
                            <div class="box-header">
                                <i class="fa fa-calendar"></i>
                                <h3 class="box-title" style="color:black;font-size: 16px;">测试考纲</h3>
                                <!-- tools box -->
                            ...
                            <div style="width:508px;height:200px;">
                                <div class="box box-primary">
                                    <div class="box-body" style="height:180px;">
                                         <label style="margin-left:10px;">暂无数据</label>
                                    </div>
                                </div>
                            </div>
                        </div>
			...
			var loadSiLv=function(){
			 ...
			 $.ajax({
	                ...
	                success: function (data) {
		                ...
		                var txt = data.schoolYear+"学年"+$("#schoolName").val()+_types[data.gradeId]+_types[data.term]+_types[data.examType]+_types[data.course]+"测试";
		                $("#titleInfo").html(txt);
	                    // 基于准备好的dom，初始化echarts实例
	                    ...
	                    var option2 = {
	                        title: {
	                            ...
	                            subtext: data.schoolYear+"学年"+$("#schoolName").val()+_types[data.gradeId]+_types[data.term]+_types[data.examType]+_types[data.course]+"测试" //副标题
	                        },
