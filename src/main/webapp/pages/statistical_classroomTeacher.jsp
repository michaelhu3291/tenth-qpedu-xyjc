...
<body>
	<div class="l_statis">
		<div class="l_title02">班主任图表统计</div>
		<div class="l_form">
...
<script type="text/javascript">
    var avgNameData1 = [],
        ...
        numberData3=[],
        dataArry3=[],
        url = "../statisticsAnalysis/subTeaScoreSearch.do?command=getAvg";
        siLvUrl="../statisticsAnalysis/subTeaScoreSearch.do?command=getSiLvForClassRoomTeacher";
        $(function () {
            $.ajax({
                url: url,
                type: "POST",
                ...
                success: function (data) {
                    $.each(data.data, function (index, item) {
                    	    avgNameData1.push(item.avgName);
                    	    avgData1.push(item.avg);
                    });
...
//                     console.info(yllLvData);
        ...
        //成绩分段学生数
        $.ajax({
            url: "../statisticsAnalysis/subTeaScoreSearch.do?command=getIntervalstuCountforClassRoomTeacher",
            type: "POST",
            data: {},
            dataType: "JSON",
            beforeSend:function(XMLHttpRequest){
