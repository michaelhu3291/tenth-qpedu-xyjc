...
<script type="text/javascript">
    ...
    /* var getPrint=function(){
    	...
    	if(courseVal !=""){
        	...
        	if(school==null){
        		var printUrl="../statisticsAnalysis/printLook.do?command=searchScoreForqpAdmin&schoolYear="+ schoolYear + "&grade="+grade+"&term="+term+"&examType="+examType+"&examNumberOrStuCode="+examNumberOrStuCode+"&courseVal="+courseVal+"&courseTxt="+courseTxt+"&idx="+idx+"&so="+so+"&scoreHtml="+scoreHtml+"&gradeTxt="+gradeTxt;
        	}else{
        		var printUrl="../statisticsAnalysis/printLook.do?command=searchScoreForqpAdmin&schoolYear="+ schoolYear + "&grade="+grade+"&term="+term+"&examType="+examType+"&school="+school+"&examNumberOrStuCode="+examNumberOrStuCode+"&courseVal="+courseVal+"&courseTxt="+courseTxt+"&idx="+idx+"&so="+so+"&scoreHtml="+scoreHtml+"&gradeTxt="+gradeTxt;
        	}
