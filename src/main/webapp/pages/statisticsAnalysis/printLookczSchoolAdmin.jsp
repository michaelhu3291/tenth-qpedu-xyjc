...
<body style="overflow: auto;">
	<div align="right">
		<span class="toolbar" style="display: none;">
			<button title="打印预览" style="margin-right: 30px;"
				onclick="on_prient();">
				...
				<table class="table table-hover table-bordered" border="1"
					...
					<tbody>
						<tr>
							...
							<td style="text-align: center; width: 5%;">班级</td>
