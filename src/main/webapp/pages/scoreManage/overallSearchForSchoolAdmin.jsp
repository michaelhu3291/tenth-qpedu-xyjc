  ...
  //根据登录用户显示其所属的年级和班级
        ...
        var getPrint=function(){
        	...
        	if(courseVal !=""){
            	...
            	if(school==null){
            		var printUrl="../scoreManage/overallSearch.do?command=printLookForAdmin&schoolYear="+ schoolYear + "&grade="+grade+"&term="+term+"&examType="+examType+"&examNumberOrStuCode="+examNumberOrStuCode+"&courseVal="+courseVal+"&courseTxt="+courseTxt+"&idx="+idx+"&so="+so+"&examNum="+examNum+"&scoreHtml="+scoreHtml+"&gradeTxt="+gradeTxt;
            	}else{
            		var printUrl="../scoreManage/overallSearch.do?command=printLookForAdmin&schoolYear="+ schoolYear + "&grade="+grade+"&term="+term+"&examType="+examType+"&school="+school+"&examNumberOrStuCode="+examNumberOrStuCode+"&courseVal="+courseVal+"&courseTxt="+courseTxt+"&idx="+idx+"&so="+so+"&examNum="+examNum+"&scoreHtml="+scoreHtml+"&gradeTxt="+gradeTxt;
            	}
		...
		$("#fastSearch_schoolAdmin").click(function() {
			...
			/* if($("#examNumber").val() === ""){
			 ...
			 //声明对象
				...
				_colModel.push(new Object("总分","Total_Score", 40, "center",true,true));
