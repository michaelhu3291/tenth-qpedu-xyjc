...
<script type="text/javascript">
    ...
    var getPrint=function(){
    	...
    	if(courseVal !=""){
        	...
        	if(school==null){
        		var printUrl="../scoreManage/overallSearch.do?command=printLookForAdmin&schoolYear="+ schoolYear + "&grade="+grade+"&term="+term+"&examType="+examType+"&examNumberOrStuCode="+examNumberOrStuCode+"&courseVal="+courseVal+"&courseTxt="+courseTxt+"&idx="+idx+"&so="+so+"&scoreHtml="+scoreHtml+"&gradeTxt="+gradeTxt;
        	}else{
    ...
    $(function () {
        ...
        $("#fastSearch_qpadmin").click(function() {
          ...
          //声明对象
			...
			_colModel.push(new Object("总分","Total_Score","Total_Score" ,40, "center",true,"true"));
			
			_colModel.push(new Object("区级名次", "orderDistrict","Total_Score", 70, "center",false,"false"));
			_colModel.push(new Object("年级名次", "orderGrade","Total_Score", 70, "center",false,"false"));
            ...
            <div id="importCondition" style="margin: -5px 10px 10px 0px;">
                <div class="search-panel" style="display: block;">
                   <div> 
                        ...
                        &nbsp;沪籍
                        <select id="homeType" name="homeType" class="form-control" style="width: 100px;" data-dic="{code:'homeType'}">
