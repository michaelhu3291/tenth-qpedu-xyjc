...
<!--startprint1-->
    <div id="jqprient">
			...
			<%for(int j=0;j<100;j++){%>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="text-align: center;width: 9%;">考号</td>
                            <td style="text-align: center;width: 12%;">学籍号</td>
                            <td style="text-align: center;width: 7%;">姓名</td>
                            <td style="text-align: center;width: 9%;">学校</td>
                        	...
                        	%>
                        	<td style="text-align: center;width: 4%;"><%=listName.get(i)%></td>
                        	<%
                            }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
                       		%>
                            <td style="text-align: center;width: 4%;">总分</td>
                            
                            <td style="text-align: center;width: 8%;">年级名次</td>
                            <td style="text-align: center;width: 6%;">班级名次</td>   
                        </tr>
        ...
        <% } %> 
						...
						<td style="text-align: center;"><%=listScore.get(b).get("orderClass")%></td>
						</tr>
						<%a++;
						  i++;
						  b=i;
