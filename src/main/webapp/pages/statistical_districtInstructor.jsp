                ...
                if (length > 0) {
                    for (var i = 0; i < length; i++) {
                        ...
                        $("#shijuan").append("<div><img class='imm' src='../theme/images/dot01.png' /><li class='titel'>"
                                     + "<a class='Ttitl' title='" + paperName + "' href='javascript:void(0)'"
                                     + "onclick='downloadExamPaper(\""+id+"\")'>" + paperName + "</a></li></div>"
            ...
            success: function (data) {
                ...
                if (length > 0) {
                    for (var i = 0; i < length; i++) {
                        ...
                        var publishdate = month + "-" + day;
                        $("#tongzhi").append("<img class='Timm' src='../theme/images/dot01.png' /><li class='titel'>" + "<a class='titl' title='" + titleName + "' href='../announceDetail.do?id=" + announceId + "' target='_blank'>" + titleName + "</a>" + "<span class='riqi'>" + publishdate + "</span></li>");
                    }
                } else {
            ...
            success: function (data) {
                ...
                if (length > 0) { //有公告数据
                    for (var i = 0; i < length; i++) {
                        ...
                        $("#gonggao").append("<img class='Timm' src='../theme/images/dot01.png' /><li class='titel'>" + "<a class='titl' title='" + titleName + "' href='../announceDetail.do?id=" + noticeId + "' target='_blank'>" + titleName + "</a>" + "<span class='riqi'>" + publishdate + "</span></li>");
                    }
                } else {
                    ...
                    <div class="col-md-7 connectedSortable ui-sortable" style="width: 50%;">
                        ...
                        <div class="box box-solid bg-white-gradient">
		                    ...
		                    <div>		
		                        ...
		                        <span style="color:black;">年级</span><select id="grade" name="grade"  class="form-control"  style="width: 80px;height:28px;display:inline;">
