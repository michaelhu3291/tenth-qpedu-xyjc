...
public class TextSqlNode implements SqlNode
{
    ...
    public boolean isDynamic()
    {
        ...
        TokenParser parser = createParser2(checker) ;
        parser.parse( text ) ;
    ...
    {
        GenericTokenParser parser2 = createParser(new BindingTokenParser(context));
        text=parser2.parse(text);

        TokenParser parser = createParser2(new BindingTokenParser(context)) ;
    ...
    private TokenParser createParser2( TokenHandler handler )
    {
