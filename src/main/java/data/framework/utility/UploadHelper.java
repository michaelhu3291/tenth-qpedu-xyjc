...
public final class UploadHelper
{
    ...
    static
    {
        try
        {
            ...
            FILE_PATH= ConfigContext.getStringSection("framework.web.upload.file_path") + "\\";
        }
        catch( Exception ex )
        {
            Logger.logError( ex ) ;
    ...
    /**
     * @Title: getRealFileUploadPath
     * @Description: 获取上传文件在服务器上的存放位置路径
     * @author zhaohuanhuan
     * @date 2017年3月10日 
     * @return String
     * @return
     */
    public static String getRealFileUploadPath() {
