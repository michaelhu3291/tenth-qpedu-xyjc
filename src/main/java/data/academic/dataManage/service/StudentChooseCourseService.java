...
@Service
public class StudentChooseCourseService extends AbstractService{
	 ...
	 * @return void
	 */
	public void insertStuCodeAndCourse(List<Map<String,Object>> list){
			insert("stuCodeAndCourse.insertStuCodeCourse",list);
